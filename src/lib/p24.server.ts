...
export const PACKAGES: Record<string, PackageDef> = {
  ...
  "vip-solo-5": { code: "vip-solo-5", name: "VIP Solo · pakiet 5", amountGrosz: 120000, credits: 5, classTypeSlugs: VIP_SOLO_SLUGS, validDays: 60 },
  "vip-duo-1": { code: "vip-duo-1", name: "VIP Duo · 1 sesja", amountGrosz: 32000 },
  "vip-duo-5": { code: "vip-duo-5", name: "VIP Duo · pakiet 5", amountGrosz: 145000, credits: 5, classTypeSlugs: VIP_DUO_SLUGS, validDays: 60 },
