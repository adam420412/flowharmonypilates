  ...
  <Html lang="pl" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Kliknij przycisk poniżej, aby zalogować się do {siteName}. Link wygasa po krótkim czasie.
        </Text>
        <Button style={button} href={confirmationUrl}>Zaloguj się</Button>
        <Text style={footer}>
          Jeśli nie prosiłaś o link, zignoruj tę wiadomość.
        </Text>
      </Container>
    </Body>
  </Html>
