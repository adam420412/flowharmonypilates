...
export const Route = createFileRoute("/kontakt")({
  head: () => ({
    meta: [
      ...
      { name: "geo.placename", content: "Kamionki" },
      { name: "geo.position", content: "52.28718;16.98349" },
      { name: "ICBM", content: "52.28718, 16.98349" },
    ],
    ...
    <div className="min-h-screen bg-cream text-foreground">
            ...
            <div className="md:flex-1">
              ...
              >
                ...
                <span className="mt-1 block text-xs text-foreground/60">
                  Adres studia (zajęcia). Dane firmy: Fites Joanna Konieczna, ul. Piotrowska 3, 61-353 Poznań.
                </span>
      ...
      <section className="px-6 pb-24 md:px-10 md:pb-32">
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-2 md:gap-16">
          <div className="space-y-10">
            <ContactRow icon={MapPin} label="Adres studia" lines={["Flow & Harmony — Studio Pilates", "ul. Poznańska 117", "62-023 Kamionki"]} />
            <ContactRow icon={Building2} label="Dane firmy (do faktur)" lines={["Fites Joanna Konieczna", "NIP 7822224858", "ul. Piotrowska 3, 61-353 Poznań"]} />
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 overflow-hidden rounded-2xl border border-foreground/10 shadow-sm">
            <iframe
              ...
              src="https://www.openstreetmap.org/export/embed.html?bbox=16.9735%2C52.2822%2C16.9935%2C52.2922&layer=mapnik&marker=52.28718%2C16.98349"
              loading="lazy"
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-xs text-foreground/70">
            <a
              href="https://www.openstreetmap.org/?mlat=52.28718&mlon=16.98349#map=18/52.28718/16.98349"
              target="_blank"
              rel="noreferrer noopener"
      ...
      <section className="bg-sand px-6 py-20 md:px-10 md:py-28">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="font-display text-4xl leading-tight md:text-5xl">Wpadnij na Reformer Pilates</h2>
          <p className="mx-auto mt-6 max-w-xl text-foreground/80">
            Pojedyncze wejście tylko 99 zł — w kameralnej grupie max 4 osób, z indywidualnym wprowadzeniem.
          </p>
